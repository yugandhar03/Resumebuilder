...
const ResumePreview = (props) => {
  const { theme, about, educationList, skills, workList, projects, printElem, languages, intenship } =
    useResume();
  ...
  return (
    <>
      <Box
        ...
        minH={"100vh"}
      >
        <div ref={printElem} onClick={props?.onClickArtboard}>
          <HStack>
            {about.picture && (
              <img
                style={imgStyle}
